        ...
        >
          ...
          >
            <div className="md:w-[90%] w-full  lg:w-3/4 bg-dull pt-4 md:py-4  md:px-4 rounded-lg space-y-2 md:space-y-4 md:border-2 border-darkGreen">
              ...
              <details className="p-4 rounded-lg open:bg-white open:shadow-xl">
                ...
                <div className="mt-3">
                  <p>
                    ...
                    culture and an encouraging workplace environment. I suggest
              ...
              <details className="p-4 rounded-lg open:bg-white open:shadow-xl">
                <summary className="font-medium">Lantra Training</summary>
                <div className="mt-3">
                  <p>
              ...
              <details className="p-4 rounded-lg open:bg-white open:shadow-xl">
                ...
                <div className="mt-3">
                  ...
                  <p>
                    ...
                    scheme member and have attended a pre workshop, read through
